...
let feedbackMenuOpenButton = document.querySelector('.action-buttons__button--feedback');
let feedbackNavigationOpenButton = document.querySelector('.navigation__button--chat');
